...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  const t = await getTranslations({ locale, namespace: "actualidad" });
...
export default async function PaginaActualidad({ params }: Props) {
  ...
  const categorias = [
    ...
    { slug: "cobertura-de-prensa", nombre: t("tipos.cobertura-de-prensa"), descripcion: sitio.actualidad?.coberturaPrensa ?? "" },
    { slug: "noticias-del-observatorio", nombre: t("tipos.noticias-del-observatorio"), descripcion: sitio.actualidad?.noticiasObservatorio ?? "" },
  ];
